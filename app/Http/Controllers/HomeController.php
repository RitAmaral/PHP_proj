<?php
//-------------isto foi criado ao escrever isto no terminal: php artisan make:controller HomeController -r
namespace App\Http\Controllers;

use App\Models\User; //-------------------------colocar isto aqui, para ele reconhecer o User
...
class HomeController extends Controller
{
     ...
     */
    public function update(\App\Http\Requests\User\UserUpdateRequest $request, string $id)
    {
        //
